...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2019 at 04:29 AM
...
(2, 'Grace Eledumo modupe', 'admin', 'admin', 'Screenshot_20180507-104929.png');
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
...
--
ALTER TABLE `reservations`
  MODIFY `reservation_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;
