			...
			<div class="row">
				<div class="col-md-12" style="margin-bottom: 40px; margin-top: -180px;">
					<div class="card">
							...
							<div class="row">
								...
								<div class="col-md-3">
									...
									<div class="products">
										...
										<a style="background-color: #90c322; color: white;" class="view-link" data-toggle="modal" data-target="#myModal" href="" >
							<i class="fa fa-plus-circle text-white" style="color: white;"></i>Add To cart</a>
									</div>	<!-- End of /.products -->
						...
						<div class="card-footer text-center"> Food Menu</div>
